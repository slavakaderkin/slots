export default {
  tabs: {
    ...
    profiles: 'Professionisti',
  },
  cta: {
    header: 'Offri servizi?',
    description: 'Crea un profilo con servizi e slot in 5 minuti e accetta clienti da Telegram.',
    header_noprofile: 'Non hai creato un profilo',
