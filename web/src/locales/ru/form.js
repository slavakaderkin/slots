export default {
  profile: {
    field: {
      ...
      country: 'Страна',
      mapLink: 'Ссылка на картах Яндекс/Google/итд',
      address: 'Адрес',
      slotDuration: 'Шаг слота',
      affiliateReward: 'Партнерское вознаграждение'
    },
    hint: {
      picture: 'Подойдет фото в формате .jpg или .png',
      name: '',
      description: '',
      country: 'Выбирайте страну, в которой находятся ваши клиенты или вы.',
      specialization: 'Кто вы в двух словах: мастер маникюра, юрист, слесарь, маг итд...',
      category: '',
      mapLink: 'Клиенты смогут найти вас на карте просто кликнув на ссылку. ',
      mapLink_link: 'Где взять ссылку >',
      address: 'Если есть адрес, напишите его начиная с города. Мы покажем его в профиле.',
      slotDuration: 'По умолчанию слот — это один час, но можно сузить до получаса. Если услуги продолжительнее часа — не проблема, система это учтет.',
      affiliateReward: 'Процент от записей по партнерской ссылке, который вы готовы выплатить тому, кто рекомендует ваш профиль. Эти деньги партнер сможет тратить на оплату ваших услуг.',
    },
    placeholder: {
      picture: 'Выберите изображение',
      name: 'Пишите тут..',
    ...
    error: {
      name: 'Без имени или названия никак, хотя бы 5 символов, но не больше 35',
      description: 'Без описания тоже не очень, хотя бы 10 символов, но не больше 1500',
