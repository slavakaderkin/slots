export default {
  ...
  cta: {
    header: 'Oferece serviços?',
    description: 'Crie um perfil com serviços e horários em 5 minutos e aceite clientes pelo Telegram.',
    header_noprofile: 'Você não criou um perfil',
