export default {
  tabs: {
    bookings: 'Randevular',
    profiles: 'Profesyoneller',
  },
  cta: {
    header: 'Hizmet mi veriyorsunuz?',
    description: '5 dakikada hizmet ve uygun zamanlarla profil oluşturun, Telegram\'dan müşteri kabul edin.',
    header_noprofile: 'Profil oluşturmadınız',
